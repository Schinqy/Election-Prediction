...
</div><div data-original-id="Bulawayo North" data-content-type="roundMarkers" data-content-index="1" class="igm-map-content" id="bulawayonorth_34"><figure class="wp-block-table is-style-stripes">
<table>
<tbody>
<tr>
<td><strong>Candidates</strong></td>
...
</div><div data-original-id="Bulawayo South" data-content-type="roundMarkers" data-content-index="2" class="igm-map-content" id="bulawayosouth_34"><figure class="wp-block-table is-style-stripes">
<table>
<tbody>
<tr>
<td><strong>Candidates</strong></td>
...
</div><div data-original-id="Mwenezi West" data-content-type="roundMarkers" data-content-index="206" class="igm-map-content" id="mweneziwest_34"><figure class="wp-block-table is-style-stripes">
<table>
<tbody>
<tr>
<td><strong>Candidates</strong></td>
...
""", html_code):
    constituency = re.sub(r"<strong>", "", match.group(1))
    candidate = re.sub(r"<strong>", "", match.group(2))
    party = re.sub(r"<strong>", "", match.group(3))
